...
class MgmoduleFourViewMetaAvgCrossAttentionSaliency(nn.Module):
    ...
    def __init__(
        ...
        self.attn_head = nn.Conv2d(self.feature_dim, 1, kernel_size=1)
    ...
    def forward(self, views: torch.Tensor, meta: torch.Tensor):
        ...
        view_tokens = self.backbone(x)                    # [B*V, D, 1, 1]
...
if __name__ == "__main__":
    ...
    dummy_meta  = torch.randn(8, 4)  # e.g. [Breast density, age, BMI, ancestry]
