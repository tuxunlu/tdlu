...
class DataInterface(pl.LightningDataModule):
    def __init__(self, **kwargs):
        ...
        print(f"Train set: {len(self.train_set)} samples")
        print(f"Validation set: {len(self.validation_set)} samples")
    ...
    def __load_data_module(self):
        ...
        train_dataset, val_dataset, test_dataset = self.__instantiate(data_class=data_class, purpose='train'), self.__instantiate(data_class=data_class, purpose='validation'), self.__instantiate(data_class=data_class, purpose='test')
